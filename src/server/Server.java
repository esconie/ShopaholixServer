...
public class Server {
    ...
    private void handleConnection(Socket socket) throws IOException {
        ...
        private String handleRequest(String input) {
                /*
                * Input: [USERID]:timestamp -> return update, if any
                * 
                ...
                */ 
                ...
                if(input.equals("NEWUSER")){
                        ...
                        String output = "";
                        int ID = Integer.parseInt(input.substring(0, 8));
                        long timeStamp = Long.parseLong(input.substring(9));
                        ...
                        user.receiveUpdate(new MemberUpdate(family, user, add, new Date(timeStamp)));
                }
                	...
                	String code = args[1];
                	long timeStamp = Long.parseLong(args[4]);                	
                	user.receiveUpdate(new RatingUpdate(code, rating, new Date(timeStamp), user));
    ...
    /**
     * Thread class that takes a Socket and handles the client connection for that socket
     */
